...
## Project status
📦 **v3.0.0** — feature-complete. Epics 1-16, 18 and 19 shipped (ledger: 69 features, 68 PASS), plus DOCX editing, PDF annotation and free-form rewriting. Current phase: daily real-world use — the next body of work will emerge from it.
