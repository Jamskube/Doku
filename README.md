...
## Project status
📦 **v3.3.0** — feature-complete. Epics 1-16, 18 and 19 shipped (ledger: 69 features, 68 PASS), plus DOCX editing, PDF annotation, free-form rewriting and durable Doku-San discussions that restore their document workspace.
...
```bash
chmod +x Doku_3.3.0_amd64.AppImage && ./Doku_3.3.0_amd64.AppImage
```
