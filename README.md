...
## Project status
📦 **v3.5.1** — feature-complete. Epics 1-16, 18 and 19 shipped (ledger: 69 features, 68 PASS), plus DOCX editing, PDF annotation, free-form rewriting and durable Doku-San discussions that restore their document workspace. Doku-San now also draws diagrams and composes HTML pages and PDF documents, checked on their real rendering before they are shown.
...
```bash
chmod +x Doku_3.5.1_amd64.AppImage && ./Doku_3.5.1_amd64.AppImage
```
